...
db.students.update({name: "Same"}, {$push: {"hobbies":"Extreme Basketweaving"}})
...
db.students.update({_id:"5daa24241c0d7475b1ed57ea"}, {$set: {gavecandy:true}})
