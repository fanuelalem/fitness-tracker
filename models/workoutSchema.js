...
workoutSchema.virtual("totalDuration").get(function () {      // using the workoutSchema, create a 'totalDuration' virtual property getter
  return this.exercises.reduce((total, exercise) => {         // for each element in the 'exercises' array, perform the following function:
